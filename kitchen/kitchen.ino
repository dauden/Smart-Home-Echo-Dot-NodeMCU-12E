...
void setup()
{
  ...
  if(wifiConnected){
    ...
    deviceOne = new Relay("Kitchen Light", 81, deviceOneOn, deviceOneOff);
    deviceTwo = new Relay("Kitchen Center", 82, deviceTwoOn, deviceTwoOff);
    deviceThree = new Relay("Kitchen Fan", 83, deviceThreeOn, deviceThreeOff);
    deviceFour = new Relay("Kitchen Smokeconsumer", 84, deviceFourOn, deviceFourOff);
