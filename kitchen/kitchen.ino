...
void setup()
{
  ...
  if(wifiConnected){
    ...
    deviceOne = new Relay("Kitchen Light", 81, relayOneControl, relayOneState);
    deviceTwo = new Relay("Kitchen Center", 82, relayTwoControl, relayTwoState);
    deviceThree = new Relay("Kitchen Fan", 83, relayThreeControl, relayThreeState);
    deviceFour = new Relay("Kitchen Smokeconsumer", 84, relayFourControl, relayFourState);
